...
export class ValidationService {
  ...
  static async validateStockUpdate(
    ...
    reason: string,
    storeId: string
  ): Promise<{ isValid: boolean; errors: string[]; currentStock?: number }> {
    const errors: string[] = [];
  ...
  static async validateForeignKeys(
    entity: 'product' | 'order' | 'customer' | 'variant',
    data: any,
    storeId: string
  ): Promise<{ isValid: boolean; errors: string[] }> {
    const errors: string[] = [];
   ...
   */
  static async checkDataConsistency(storeId: string): Promise<{ isConsistent: boolean; issues: string[] }> {
    const issues: string[] = [];
