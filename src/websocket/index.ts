...
export function createWebSocketServer(fastify: any) {
  ...
  const storeConnections = new Map<string, any[]>();
  ...
  io.on('connection', (socket) => {
    ...
    // Handle POS events
    socket.on('pos_cart_update', (data: any) => {
    ...
    socket.on('pos_payment_started', (data: any) => {
    ...
    socket.on('pos_order_completed', (data: any) => {
    ...
    socket.on('pos_cart_cleared', (data: any) => {
